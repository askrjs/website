...
export function SsgOverviewDocPage() {
  return (
    <DocLayout title={meta.title} intro={meta.summary}>
      ...
      <section>
        <h2>Build Modes</h2>
        <p>Use full builds for release branches and incremental builds during rapid iteration.</p>
        <p>Keep route keys stable so incremental invalidation remains predictable.</p>
      </section>
    </DocLayout>
  );
}