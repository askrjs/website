  ...
  return (
    <DocLayout title={meta.title} intro={meta.summary}>
      <section>
        <h2>Token Layers</h2>
        <p>
          Define semantic tokens once and consume them in app-level and component-level
          styles.
        </p>
        <p>
          Prefer semantic names over hardcoded color literals so themes can evolve safely.
        </p>
      </section>
      <section>
