  ...
  return (
    <DocLayout title={meta.title} intro={meta.summary} meta={meta}>
      <section>
        ...
        <p>
          Start from semantic tokens for color, spacing, typography, and radius so components
          inherit a coherent language.
        </p>
        <p>
          Keep local overrides sparse and prefer system-level token changes over component-specific
          forks.
        </p>
      </section>
      <section>
        ...
        <p>
          Define light and dark values at the token layer and let components consume them without
          branching.
        </p>
        <p>A small theme bootstrap script can prevent color-mode flash before the page paints.</p>
      </section>
    </DocLayout>
  );
}
