...
import type { DocMeta } from '../../../site/doc-types';
  ...
  return (
    <DocLayout title={meta.title} intro={meta.summary}>
      <section>
        ...
        <p>
          Install @askrjs/askr for runtime primitives, @askrjs/askr-ui for headless
          components, and @askrjs/askr-themes for CSS theme tokens.
        </p>
      ...
      <section>
        ...
        <p>
          Start with a tiny route graph and one interactive island so rendering and
          hydration are easy to validate.
        </p>
