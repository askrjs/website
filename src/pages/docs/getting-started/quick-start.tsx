  ...
  return (
    <DocLayout title={meta.title} intro={meta.summary}>
      <section>
        ...
        <p>
          Keep event handlers pure and push async work into resource() so cancellation
          is automatic.
        </p>
      </section>
      <section>
        ...
        <p>
          Import a small set of askr-ui components and apply askr-themes CSS at the app
          shell level.
        </p>
